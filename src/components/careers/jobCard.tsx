...
export function JobCard({
  ...
  return (
    <Card
      className={
        "w-[260px] md:w-[400px] lg:w-[400px] h-[260px] p-0 box-border overflow-hidden"
      }
    >
      <div className="flex w-full gap-3 h-full">
        {/* {image part} */}
        <div className="w-1/3 h-[100%] relative">
        ...
        <div className="w-2/3 flex flex-col gap-5">
          {/* job title */}
          <h3 className="text-[#007AFF] text-xl ">{title}</h3>
          ...
          <div className="flex text-sectionColor">
            <span className="w-1/3">From Close</span>
            <span>:</span>
